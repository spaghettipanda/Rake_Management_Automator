...
try:
    ...
    go = message_box('O/C', 'Please download the cycle point and car count data from RVC\n\nKeep them as "RVC.csv" and "RVC (1).csv"\n\nOnce ready, click OK to proceed with data cleaning and email generation...', 'Click OK to proceed...') 
    print()
